...
//				.print(); // it's not implemented yet
	...
	public void TC_DM_020_Users_are_able_to_set_autoGenerated_hostName() throws InterruptedException {
		deviceManagerPage
				.selectTheGroup("UEM_AUTOMATION")
				.applyComputerNameSettingsWithAutoGeneratedHostName("test", "", "Mac Address", "12", "prajwal", "123");
	}

	@Test(priority = 21) // UX-UEM-WD-019  // try to execute this test on offline group to see the status
	public void TC_DM_021_Users_are_able_to_add_specific_task_on_the_groupProfile() throws InterruptedException {
		deviceManagerPage
				...
				.selectTheGroup("UEM_AUTOMATION")
				.verifyDataOnGroupInformation("Policy Count", "1");
	}

	@Test(priority = 22) // UX-UEM-WD-020  // try to execute this test on offline group to see the status
	public void TC_DM_022_Users_are_able_to_add_batchCount_and_batchInterval() throws InterruptedException {
		deviceManagerPage
				.selectTheGroup("UEM_AUTOMATION")
				.removeAllPoliciesIn("Policy Count")
